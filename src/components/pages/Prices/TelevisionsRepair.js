...
function TelevisionsRepair() {
    document.title = "Ремонт телевізорів";
    ...
    useEffect(() => {
        ...
        fetch("http://127.0.0.1:8000/api/type_repair")
            ...
            .then((json) => {
                const filteredResults = json.filter(repairType => repairType.category_id === 6);
...
export default TelevisionsRepair;