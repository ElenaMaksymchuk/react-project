...
function BreadOvensRepair() {
    document.title = "Ремонт хлібопічок";
    ...
    useEffect(() => {
        ...
        fetch("http://127.0.0.1:8000/api/type_repair")
            ...
            .then((json) => {
                const filteredResults = json.filter(repairType => repairType.category_id === 7);
...
export default BreadOvensRepair;